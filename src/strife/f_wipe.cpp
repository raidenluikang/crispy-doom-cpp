...
( int	x,
  ...
  int	height )
{
    wipe_scr_start = zmalloc<decltype(    wipe_scr_start)>(SCREENWIDTH * SCREENHEIGHT, PU_STATIC, nullptr);
...
( int	x,
  ...
  int	height )
{
    wipe_scr_end = zmalloc<decltype(    wipe_scr_end)>(SCREENWIDTH * SCREENHEIGHT, PU_STATIC, nullptr);
