...
void R_InitTranslationTables (void)
{
    ...
    translationtables = zmalloc<decltype(translationtables)>(256*8, PU_STATIC, 0);
...
{ 
    ...
    if (background_buffer == nullptr)
    {
        background_buffer = zmalloc<decltype(        background_buffer)>(MAXWIDTH * (MAXHEIGHT - SBARHEIGHT),
                                     PU_STATIC, nullptr);
    }
