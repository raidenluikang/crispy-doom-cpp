...
//
    ...
    texturecolumnofs = zmalloc<decltype(    texturecolumnofs)>(numtextures * sizeof(unsigned short *), PU_STATIC, 0);
    ...
    for (i = 0; i < numtextures; i++, directory++)
    {
        ...
        texturecolumnlump[i] = zmalloc<decltype(        texturecolumnlump[i])>(texture->width * sizeof(short),
                                        PU_STATIC, 0);
        texturecolumnofs[i] = zmalloc<decltype(        texturecolumnofs[i])>(texture->width * sizeof(short), 
                                       PU_STATIC, 0);
        j = 1;
