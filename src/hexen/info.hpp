...
constexpr statenum_t operator + (statenum_t lhs, int rhs) noexcept 
{
    return static_cast<statenum_t>(static_cast<int>(lhs) + rhs);
}
...
constexpr mobjtype_t operator + (mobjtype_t lhs, int rhs) noexcept {
    return static_cast<mobjtype_t>(static_cast<int>(lhs) + rhs) ;
}
